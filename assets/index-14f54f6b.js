...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:On,depthTest:!1,depthWrite:!1})}function Xo(){return new li({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ya(),fragmentShader:`
		...
		`,blending:On,depthTest:!1,depthWrite:!1})}function Yo(){return new li({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ya(),fragmentShader:`
	...
	`}function yp(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===Ks||l===$s,u=l===Fi||l===Bi;if(c||u)if(a.isRenderTargetTexture&&a.needsPMREMUpdate===!0){a.needsPMREMUpdate=!1;let h=e.get(a);return t===null&&(t=new Vo(i)),h=c?t.fromEquirectangular(a,h):t.fromCubemap(a,h),e.set(a,h),h.texture}else{if(e.has(a))return e.get(a).texture;{const h=a.image;if(c&&h&&h.height>0||u&&h&&r(h)){t===null&&(t=new Vo(i));const f=c?t.fromEquirectangular(a):t.fromCubemap(a);return e.set(a,f),a.addEventListener("dispose",s),f.texture}else return null}}}return a}function r(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function Mp(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?t("EXT_color_buffer_float"):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){const r=t(n);return r===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function Sp(i,e,t,n){const r={},s=new WeakMap;function o(h){const f=h.target;f.index!==null&&e.remove(f.index);for(const _ in f.attributes)e.remove(f.attributes[_]);for(const _ in f.morphAttributes){const g=f.morphAttributes[_];for(let p=0,d=g.length;p<d;p++)e.remove(g[p])}f.removeEventListener("dispose",o),delete r[f.id];const m=s.get(f);m&&(e.remove(m),s.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function a(h,f){return r[f.id]===!0||(f.addEventListener("dispose",o),r[f.id]=!0,t.memory.geometries++),f}function l(h){const f=h.attributes;for(const _ in f)e.update(f[_],i.ARRAY_BUFFER);const m=h.morphAttributes;for(const _ in m){const g=m[_];for(let p=0,d=g.length;p<d;p++)e.update(g[p],i.ARRAY_BUFFER)}}function c(h){const f=[],m=h.index,_=h.attributes.position;let g=0;if(m!==null){const T=m.array;g=m.version;for(let x=0,E=T.length;x<E;x+=3){const b=T[x+0],C=T[x+1],P=T[x+2];f.push(b,C,C,P,P,b)}}else{const T=_.array;g=_.version;for(let x=0,E=T.length/3-1;x<E;x+=3){const b=x+0,C=x+1,P=x+2;f.push(b,C,C,P,P,b)}}const p=new(ec(f)?oc:ac)(f,1);p.version=g;const d=s.get(h);d&&e.remove(d),s.set(h,p)}function u(h){const f=s.get(h);if(f){const m=h.index;m!==null&&f.version<m.version&&c(h)}else c(h);return s.get(h)}return{get:a,update:l,getWireframeAttribute:u}}function bp(i,e,t,n){const r=n.isWebGL2;let s;function o(f){s=f}let a,l;function c(f){a=f.type,l=f.bytesPerElement}function u(f,m){i.drawElements(s,m,a,f*l),t.update(m,s,1)}function h(f,m,_){if(_===0)return;let g,p;if(r)g=i,p="drawElementsInstanced";else if(g=e.get("ANGLE_instanced_arrays"),p="drawElementsInstancedANGLE",g===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}g[p](s,m,a,f*l,_),t.update(m,s,_)}this.setMode=o,this.setIndex=c,this.render=u,this.renderInstances=h}function Ep(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(s/3);break;case i.LINES:t.lines+=a*(s/2);break;case i.LINE_STRIP:t.lines+=a*(s-1);break;case i.LINE_LOOP:t.lines+=a*s;break;case i.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Tp(i,e){return i[0]-e[0]}function Ap(i,e){return Math.abs(e[1])-Math.abs(i[1])}function wp(i,e,t){const n={},r=new Float32Array(8),s=new WeakMap,o=new $e,a=[];for(let c=0;c<8;c++)a[c]=[c,0];function l(c,u,h){const f=c.morphTargetInfluences;if(e.isWebGL2===!0){const _=u.morphAttributes.position||u.morphAttributes.normal||u.morphAttributes.color,g=_!==void 0?_.length:0;let p=s.get(u);if(p===void 0||p.count!==g){let V=function(){B.dispose(),s.delete(u),u.removeEventListener("dispose",V)};var m=V;p!==void 0&&p.texture.dispose();const x=u.morphAttributes.position!==void 0,E=u.morphAttributes.normal!==void 0,b=u.morphAttributes.color!==void 0,C=u.morphAttributes.position||[],P=u.morphAttributes.normal||[],z=u.morphAttributes.color||[];let y=0;x===!0&&(y=1),E===!0&&(y=2),b===!0&&(y=3);let w=u.attributes.position.count*y,$=1;w>e.maxTextureSize&&($=Math.ceil(w/e.maxTextureSize),w=e.maxTextureSize);const ie=new Float32Array(w*$*4*g),B=new ic(ie,w,$,g);B.type=Nn,B.needsUpdate=!0;const G=y*4;for(let Q=0;Q<g;Q++){const q=C[Q],K=P[Q],re=z[Q],Z=w*$*4*Q;for(let xe=0;xe<q.count;xe++){const O=xe*G;x===!0&&(o.fromBufferAttribute(q,xe),ie[Z+O+0]=o.x,ie[Z+O+1]=o.y,ie[Z+O+2]=o.z,ie[Z+O+3]=0),E===!0&&(o.fromBufferAttribute(K,xe),ie[Z+O+4]=o.x,ie[Z+O+5]=o.y,ie[Z+O+6]=o.z,ie[Z+O+7]=0),b===!0&&(o.fromBufferAttribute(re,xe),ie[Z+O+8]=o.x,ie[Z+O+9]=o.y,ie[Z+O+10]=o.z,ie[Z+O+11]=re.itemSize===4?o.w:1)}}p={count:g,texture:B,size:new he(w,$)},s.set(u,p),u.addEventListener("dispose",V)}let d=0;for(let x=0;x<f.length;x++)d+=f[x];const T=u.morphTargetsRelative?1:1-d;h.getUniforms().setValue(i,"morphTargetBaseInfluence",T),h.getUniforms().setValue(i,"morphTargetInfluences",f),h.getUniforms().setValue(i,"morphTargetsTexture",p.texture,t),h.getUniforms().setValue(i,"morphTargetsTextureSize",p.size)}else{const _=f===void 0?0:f.length;let g=n[u.id];if(g===void 0||g.length!==_){g=[];for(let E=0;E<_;E++)g[E]=[E,0];n[u.id]=g}for(let E=0;E<_;E++){const b=g[E];b[0]=E,b[1]=f[E]}g.sort(Ap);for(let E=0;E<8;E++)E<_&&g[E][1]?(a[E][0]=g[E][0],a[E][1]=g[E][1]):(a[E][0]=Number.MAX_SAFE_INTEGER,a[E][1]=0);a.sort(Tp);const p=u.morphAttributes.position,d=u.morphAttributes.normal;let T=0;for(let E=0;E<8;E++){const b=a[E],C=b[0],P=b[1];C!==Number.MAX_SAFE_INTEGER&&P?(p&&u.getAttribute("morphTarget"+E)!==p[C]&&u.setAttribute("morphTarget"+E,p[C]),d&&u.getAttribute("morphNormal"+E)!==d[C]&&u.setAttribute("morphNormal"+E,d[C]),r[E]=P,T+=P):(p&&u.hasAttribute("morphTarget"+E)===!0&&u.deleteAttribute("morphTarget"+E),d&&u.hasAttribute("morphNormal"+E)===!0&&u.deleteAttribute("morphNormal"+E),r[E]=0)}const x=u.morphTargetsRelative?1:1-T;h.getUniforms().setValue(i,"morphTargetBaseInfluence",x),h.getUniforms().setValue(i,"morphTargetInfluences",r)}}return{update:l}}function Rp(i,e,t,n){let r=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,h=e.get(l,u);return r.get(h)!==c&&(e.update(h),r.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER)),h}function o(){r=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:o}}const hc=new Ut,dc=new ic,fc=new mh,pc=new ga,qo=[],jo=[],Ko=new Float32Array(16),$o=new Float32Array(9),Jo=new Float32Array(4);function Xi(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=qo[r];if(s===void 0&&(s=new Float32Array(r),qo[r]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(s,a)}return s}function lt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function ct(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function as(i,e){let t=jo[e];t===void 0&&(t=new Int32Array(e),jo[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Cp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Lp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(lt(t,e))return;i.uniform2fv(this.addr,e),ct(t,e)}}function Pp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(lt(t,e))return;i.uniform3fv(this.addr,e),ct(t,e)}}function Dp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(lt(t,e))return;i.uniform4fv(this.addr,e),ct(t,e)}}function Up(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(lt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),ct(t,e)}else{if(lt(t,n))return;Jo.set(n),i.uniformMatrix2fv(this.addr,!1,Jo),ct(t,n)}}function Ip(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(lt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),ct(t,e)}else{if(lt(t,n))return;$o.set(n),i.uniformMatrix3fv(this.addr,!1,$o),ct(t,n)}}function Np(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(lt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),ct(t,e)}else{if(lt(t,n))return;Ko.set(n),i.uniformMatrix4fv(this.addr,!1,Ko),ct(t,n)}}function Op(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Fp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(lt(t,e))return;i.uniform2iv(this.addr,e),ct(t,e)}}function Bp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(lt(t,e))return;i.uniform3iv(this.addr,e),ct(t,e)}}function zp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(lt(t,e))return;i.uniform4iv(this.addr,e),ct(t,e)}}function Hp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function kp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(lt(t,e))return;i.uniform2uiv(this.addr,e),ct(t,e)}}function Gp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(lt(t,e))return;i.uniform3uiv(this.addr,e),ct(t,e)}}function Vp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(lt(t,e))return;i.uniform4uiv(this.addr,e),ct(t,e)}}function Wp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2D(e||hc,r)}function Xp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||fc,r)}function Yp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||pc,r)}function qp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||dc,r)}function jp(i){switch(i){case 5126:return Cp;case 35664:return Lp;case 35665:return Pp;case 35666:return Dp;case 35674:return Up;case 35675:return Ip;case 35676:return Np;case 5124:case 35670:return Op;case 35667:case 35671:return Fp;case 35668:case 35672:return Bp;case 35669:case 35673:return zp;case 5125:return Hp;case 36294:return kp;case 36295:return Gp;case 36296:return Vp;case 35678:case 36198:case 36298:case 36306:case 35682:return Wp;case 35679:case 36299:case 36307:return Xp;case 35680:case 36300:case 36308:case 36293:return Yp;case 36289:case 36303:case 36311:case 36292:return qp}}function Kp(i,e){i.uniform1fv(this.addr,e)}function $p(i,e){const t=Xi(e,this.size,2);i.uniform2fv(this.addr,t)}function Jp(i,e){const t=Xi(e,this.size,3);i.uniform3fv(this.addr,t)}function Zp(i,e){const t=Xi(e,this.size,4);i.uniform4fv(this.addr,t)}function Qp(i,e){const t=Xi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function em(i,e){const t=Xi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function tm(i,e){const t=Xi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function nm(i,e){i.uniform1iv(this.addr,e)}function im(i,e){i.uniform2iv(this.addr,e)}function rm(i,e){i.uniform3iv(this.addr,e)}function sm(i,e){i.uniform4iv(this.addr,e)}function am(i,e){i.uniform1uiv(this.addr,e)}function om(i,e){i.uniform2uiv(this.addr,e)}function lm(i,e){i.uniform3uiv(this.addr,e)}function cm(i,e){i.uniform4uiv(this.addr,e)}function um(i,e,t){const n=this.cache,r=e.length,s=as(t,r);lt(n,s)||(i.uniform1iv(this.addr,s),ct(n,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||hc,s[o])}function hm(i,e,t){const n=this.cache,r=e.length,s=as(t,r);lt(n,s)||(i.uniform1iv(this.addr,s),ct(n,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||fc,s[o])}function dm(i,e,t){const n=this.cache,r=e.length,s=as(t,r);lt(n,s)||(i.uniform1iv(this.addr,s),ct(n,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||pc,s[o])}function fm(i,e,t){const n=this.cache,r=e.length,s=as(t,r);lt(n,s)||(i.uniform1iv(this.addr,s),ct(n,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||dc,s[o])}function pm(i){switch(i){case 5126:return Kp;case 35664:return $p;case 35665:return Jp;case 35666:return Zp;case 35674:return Qp;case 35675:return em;case 35676:return tm;case 5124:case 35670:return nm;case 35667:case 35671:return im;case 35668:case 35672:return rm;case 35669:case 35673:return sm;case 5125:return am;case 36294:return om;case 36295:return lm;case 36296:return cm;case 35678:case 36198:case 36298:case 36306:case 35682:return um;case 35679:case 36299:case 36307:return hm;case 35680:case 36300:case 36308:case 36293:return dm;case 36289:case 36303:case 36311:case 36292:return fm}}class mm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.setValue=jp(t.type)}}class _m{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.size=t.size,this.setValue=pm(t.type)}}class gm{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],n)}}}const Bs=/(\w+)(\])?(\[|\.)?/g;function Zo(i,e){i.seq.push(e),i.map[e.id]=e}function vm(i,e,t){const n=i.name,r=n.length;for(Bs.lastIndex=0;;){const s=Bs.exec(n),o=Bs.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===r){Zo(t,c===void 0?new mm(a,i,e):new _m(a,i,e));break}else{let h=t.map[a];h===void 0&&(h=new gm(a),Zo(t,h)),t=h}}}class Qr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);vm(s,o,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&n.push(o)}return n}}function Qo(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}let xm=0;function ym(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function Mm(i){switch(i){case mn:return["Linear","( value )"];case De:return["sRGB","( value )"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),["Linear","( value )"]}}function el(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+ym(i.getShaderSource(e),o)}else return r}function Sm(i,e){const t=Mm(e);return"vec4 "+i+"( vec4 value ) { return LinearTo"+t[0]+t[1]+"; }"}function bm(i,e){let t;switch(e){case yu:t="Linear";break;case Mu:t="Reinhard";break;case Su:t="OptimizedCineon";break;case bu:t="ACESFilmic";break;case Eu:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function Em(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(ir).join(`
`)}function Tm(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Am(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function ir(i){return i!==""}function tl(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function nl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const wm=/^[ \t]*#include +<([\w\d./]+)>/gm;function ta(i){return i.replace(wm,Rm)}function Rm(i,e){const t=Ne[e];if(t===void 0)throw new Error("Can not resolve #include <"+e+">");return ta(t)}const Cm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function il(i){return i.replace(Cm,Lm)}function Lm(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function rl(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function Pm(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Gl?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Zc?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===An&&(e="SHADOWMAP_TYPE_VSM"),e}function Dm(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Fi:case Bi:e="ENVMAP_TYPE_CUBE";break;case rs:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Um(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Bi:e="ENVMAP_MODE_REFRACTION";break}return e}function Im(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case da:e="ENVMAP_BLENDING_MULTIPLY";break;case vu:e="ENVMAP_BLENDING_MIX";break;case xu:e="ENVMAP_BLENDING_ADD";break}return e}function Nm(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Om(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=Pm(t),c=Dm(t),u=Um(t),h=Im(t),f=Nm(t),m=t.isWebGL2?"":Em(t),_=Tm(s),g=r.createProgram();let p,d,T=t.glslVersion?"#version "+t.glslVersion+`
`:"";t.isRawShaderMaterial?(p=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,_].filter(ir).join(`
`),p.length>0&&(p+=`
`),d=[m,"#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,_].filter(ir).join(`
`),d.length>0&&(d+=`
`)):(p=[rl(t),"#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,_,t.instancing?"#define USE_INSTANCING":"",t.instancingColor?"#define USE_INSTANCING_COLOR":"",t.useFog&&t.fog?"#define USE_FOG":"",t.useFog&&t.fogExp2?"#define FOG_EXP2":"",t.map?"#define USE_MAP":"",t.envMap?"#define USE_ENVMAP":"",t.envMap?"#define "+u:"",t.lightMap?"#define USE_LIGHTMAP":"",t.aoMap?"#define USE_AOMAP":"",t.bumpMap?"#define USE_BUMPMAP":"",t.normalMap?"#define USE_NORMALMAP":"",t.normalMapObjectSpace?"#define USE_NORMALMAP_OBJECTSPACE":"",t.normalMapTangentSpace?"#define USE_NORMALMAP_TANGENTSPACE":"",t.displacementMap?"#define USE_DISPLACEMENTMAP":"",t.emissiveMap?"#define USE_EMISSIVEMAP":"",t.anisotropyMap?"#define USE_ANISOTROPYMAP":"",t.clearcoatMap?"#define USE_CLEARCOATMAP":"",t.clearcoatRoughnessMap?"#define USE_CLEARCOAT_ROUGHNESSMAP":"",t.clearcoatNormalMap?"#define USE_CLEARCOAT_NORMALMAP":"",t.iridescenceMap?"#define USE_IRIDESCENCEMAP":"",t.iridescenceThicknessMap?"#define USE_IRIDESCENCE_THICKNESSMAP":"",t.specularMap?"#define USE_SPECULARMAP":"",t.specularColorMap?"#define USE_SPECULAR_COLORMAP":"",t.specularIntensityMap?"#define USE_SPECULAR_INTENSITYMAP":"",t.roughnessMap?"#define USE_ROUGHNESSMAP":"",t.metalnessMap?"#define USE_METALNESSMAP":"",t.alphaMap?"#define USE_ALPHAMAP":"",t.transmission?"#define USE_TRANSMISSION":"",t.transmissionMap?"#define USE_TRANSMISSIONMAP":"",t.thicknessMap?"#define USE_THICKNESSMAP":"",t.sheenColorMap?"#define USE_SHEEN_COLORMAP":"",t.sheenRoughnessMap?"#define USE_SHEEN_ROUGHNESSMAP":"",t.mapUv?"#define MAP_UV "+t.mapUv:"",t.alphaMapUv?"#define ALPHAMAP_UV "+t.alphaMapUv:"",t.lightMapUv?"#define LIGHTMAP_UV "+t.lightMapUv:"",t.aoMapUv?"#define AOMAP_UV "+t.aoMapUv:"",t.emissiveMapUv?"#define EMISSIVEMAP_UV "+t.emissiveMapUv:"",t.bumpMapUv?"#define BUMPMAP_UV "+t.bumpMapUv:"",t.normalMapUv?"#define NORMALMAP_UV "+t.normalMapUv:"",t.displacementMapUv?"#define DISPLACEMENTMAP_UV "+t.displacementMapUv:"",t.metalnessMapUv?"#define METALNESSMAP_UV "+t.metalnessMapUv:"",t.roughnessMapUv?"#define ROUGHNESSMAP_UV "+t.roughnessMapUv:"",t.anisotropyMapUv?"#define ANISOTROPYMAP_UV "+t.anisotropyMapUv:"",t.clearcoatMapUv?"#define CLEARCOATMAP_UV "+t.clearcoatMapUv:"",t.clearcoatNormalMapUv?"#define CLEARCOAT_NORMALMAP_UV "+t.clearcoatNormalMapUv:"",t.clearcoatRoughnessMapUv?"#define CLEARCOAT_ROUGHNESSMAP_UV "+t.clearcoatRoughnessMapUv:"",t.iridescenceMapUv?"#define IRIDESCENCEMAP_UV "+t.iridescenceMapUv:"",t.iridescenceThicknessMapUv?"#define IRIDESCENCE_THICKNESSMAP_UV "+t.iridescenceThicknessMapUv:"",t.sheenColorMapUv?"#define SHEEN_COLORMAP_UV "+t.sheenColorMapUv:"",t.sheenRoughnessMapUv?"#define SHEEN_ROUGHNESSMAP_UV "+t.sheenRoughnessMapUv:"",t.specularMapUv?"#define SPECULARMAP_UV "+t.specularMapUv:"",t.specularColorMapUv?"#define SPECULAR_COLORMAP_UV "+t.specularColorMapUv:"",t.specularIntensityMapUv?"#define SPECULAR_INTENSITYMAP_UV "+t.specularIntensityMapUv:"",t.transmissionMapUv?"#define TRANSMISSIONMAP_UV "+t.transmissionMapUv:"",t.thicknessMapUv?"#define THICKNESSMAP_UV "+t.thicknessMapUv:"",t.vertexTangents?"#define USE_TANGENT":"",t.vertexColors?"#define USE_COLOR":"",t.vertexAlphas?"#define USE_COLOR_ALPHA":"",t.vertexUv1s?"#define USE_UV1":"",t.vertexUv2s?"#define USE_UV2":"",t.vertexUv3s?"#define USE_UV3":"",t.pointsUvs?"#define USE_POINTS_UV":"",t.flatShading?"#define FLAT_SHADED":"",t.skinning?"#define USE_SKINNING":"",t.morphTargets?"#define USE_MORPHTARGETS":"",t.morphNormals&&t.flatShading===!1?"#define USE_MORPHNORMALS":"",t.morphColors&&t.isWebGL2?"#define USE_MORPHCOLORS":"",t.morphTargetsCount>0&&t.isWebGL2?"#define MORPHTARGETS_TEXTURE":"",t.morphTargetsCount>0&&t.isWebGL2?"#define MORPHTARGETS_TEXTURE_STRIDE "+t.morphTextureStride:"",t.morphTargetsCount>0&&t.isWebGL2?"#define MORPHTARGETS_COUNT "+t.morphTargetsCount:"",t.doubleSided?"#define DOUBLE_SIDED":"",t.flipSided?"#define FLIP_SIDED":"",t.shadowMapEnabled?"#define USE_SHADOWMAP":"",t.shadowMapEnabled?"#define "+l:"",t.sizeAttenuation?"#define USE_SIZEATTENUATION":"",t.useLegacyLights?"#define LEGACY_LIGHTS":"",t.logarithmicDepthBuffer?"#define USE_LOGDEPTHBUF":"",t.logarithmicDepthBuffer&&t.rendererExtensionFragDepth?"#define USE_LOGDEPTHBUF_EXT":"","uniform mat4 modelMatrix;","uniform mat4 modelViewMatrix;","uniform mat4 projectionMatrix;","uniform mat4 viewMatrix;","uniform mat3 normalMatrix;","uniform vec3 cameraPosition;","uniform bool isOrthographic;","#ifdef USE_INSTANCING","	attribute mat4 instanceMatrix;","#endif","#ifdef USE_INSTANCING_COLOR","	attribute vec3 instanceColor;","#endif","attribute vec3 position;","attribute vec3 normal;","attribute vec2 uv;","#ifdef USE_UV1","	attribute vec2 uv1;","#endif","#ifdef USE_UV2","	attribute vec2 uv2;","#endif","#ifdef USE_UV3","	attribute vec2 uv3;","#endif","#ifdef USE_TANGENT","	attribute vec4 tangent;","#endif","#if defined( USE_COLOR_ALPHA )","	attribute vec4 color;","#elif defined( USE_COLOR )","	attribute vec3 color;","#endif","#if ( defined( USE_MORPHTARGETS ) && ! defined( MORPHTARGETS_TEXTURE ) )","	attribute vec3 morphTarget0;","	attribute vec3 morphTarget1;","	attribute vec3 morphTarget2;","	attribute vec3 morphTarget3;","	#ifdef USE_MORPHNORMALS","		attribute vec3 morphNormal0;","		attribute vec3 morphNormal1;","		attribute vec3 morphNormal2;","		attribute vec3 morphNormal3;","	#else","		attribute vec3 morphTarget4;","		attribute vec3 morphTarget5;","		attribute vec3 morphTarget6;","		attribute vec3 morphTarget7;","	#endif","#endif","#ifdef USE_SKINNING","	attribute vec4 skinIndex;","	attribute vec4 skinWeight;","#endif",`
`].filter(ir).join(`
`),d=[m,rl(t),"#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,_,t.useFog&&t.fog?"#define USE_FOG":"",t.useFog&&t.fogExp2?"#define FOG_EXP2":"",t.map?"#define USE_MAP":"",t.matcap?"#define USE_MATCAP":"",t.envMap?"#define USE_ENVMAP":"",t.envMap?"#define "+c:"",t.envMap?"#define "+u:"",t.envMap?"#define "+h:"",f?"#define CUBEUV_TEXEL_WIDTH "+f.texelWidth:"",f?"#define CUBEUV_TEXEL_HEIGHT "+f.texelHeight:"",f?"#define CUBEUV_MAX_MIP "+f.maxMip+".0":"",t.lightMap?"#define USE_LIGHTMAP":"",t.aoMap?"#define USE_AOMAP":"",t.bumpMap?"#define USE_BUMPMAP":"",t.normalMap?"#define USE_NORMALMAP":"",t.normalMapObjectSpace?"#define USE_NORMALMAP_OBJECTSPACE":"",t.normalMapTangentSpace?"#define USE_NORMALMAP_TANGENTSPACE":"",t.emissiveMap?"#define USE_EMISSIVEMAP":"",t.anisotropy?"#define USE_ANISOTROPY":"",t.anisotropyMap?"#define USE_ANISOTROPYMAP":"",t.clearcoat?"#define USE_CLEARCOAT":"",t.clearcoatMap?"#define USE_CLEARCOATMAP":"",t.clearcoatRoughnessMap?"#define USE_CLEARCOAT_ROUGHNESSMAP":"",t.clearcoatNormalMap?"#define USE_CLEARCOAT_NORMALMAP":"",t.iridescence?"#define USE_IRIDESCENCE":"",t.iridescenceMap?"#define USE_IRIDESCENCEMAP":"",t.iridescenceThicknessMap?"#define USE_IRIDESCENCE_THICKNESSMAP":"",t.specularMap?"#define USE_SPECULARMAP":"",t.specularColorMap?"#define USE_SPECULAR_COLORMAP":"",t.specularIntensityMap?"#define USE_SPECULAR_INTENSITYMAP":"",t.roughnessMap?"#define USE_ROUGHNESSMAP":"",t.metalnessMap?"#define USE_METALNESSMAP":"",t.alphaMap?"#define USE_ALPHAMAP":"",t.alphaTest?"#define USE_ALPHATEST":"",t.sheen?"#define USE_SHEEN":"",t.sheenColorMap?"#define USE_SHEEN_COLORMAP":"",t.sheenRoughnessMap?"#define USE_SHEEN_ROUGHNESSMAP":"",t.transmission?"#define USE_TRANSMISSION":"",t.transmissionMap?"#define USE_TRANSMISSIONMAP":"",t.thicknessMap?"#define USE_THICKNESSMAP":"",t.vertexTangents?"#define USE_TANGENT":"",t.vertexColors||t.instancingColor?"#define USE_COLOR":"",t.vertexAlphas?"#define USE_COLOR_ALPHA":"",t.vertexUv1s?"#define USE_UV1":"",t.vertexUv2s?"#define USE_UV2":"",t.vertexUv3s?"#define USE_UV3":"",t.pointsUvs?"#define USE_POINTS_UV":"",t.gradientMap?"#define USE_GRADIENTMAP":"",t.flatShading?"#define FLAT_SHADED":"",t.doubleSided?"#define DOUBLE_SIDED":"",t.flipSided?"#define FLIP_SIDED":"",t.shadowMapEnabled?"#define USE_SHADOWMAP":"",t.shadowMapEnabled?"#define "+l:"",t.premultipliedAlpha?"#define PREMULTIPLIED_ALPHA":"",t.useLegacyLights?"#define LEGACY_LIGHTS":"",t.logarithmicDepthBuffer?"#define USE_LOGDEPTHBUF":"",t.logarithmicDepthBuffer&&t.rendererExtensionFragDepth?"#define USE_LOGDEPTHBUF_EXT":"","uniform mat4 viewMatrix;","uniform vec3 cameraPosition;","uniform bool isOrthographic;",t.toneMapping!==Rn?"#define TONE_MAPPING":"",t.toneMapping!==Rn?Ne.tonemapping_pars_fragment:"",t.toneMapping!==Rn?bm("toneMapping",t.toneMapping):"",t.dithering?"#define DITHERING":"",t.opaque?"#define OPAQUE":"",Ne.encodings_pars_fragment,Sm("linearToOutputTexel",t.outputColorSpace),t.useDepthPacking?"#define DEPTH_PACKING "+t.depthPacking:"",`
`].filter(ir).join(`
`)),o=ta(o),o=tl(o,t),o=nl(o,t),a=ta(a),a=tl(a,t),a=nl(a,t),o=il(o),a=il(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(T=`#version 300 es
...
</div>`,Z_=function(e,t){var n=e[t];return j.isArray(arguments[2])||j.isObject(arguments[2])?new X_(e,t,arguments[2]):j.isNumber(n)?j.isNumber(arguments[2])&&j.isNumber(arguments[3])?j.isNumber(arguments[4])?new aa(e,t,arguments[2],arguments[3],arguments[4]):new aa(e,t,arguments[2],arguments[3]):j.isNumber(arguments[4])?new is(e,t,{min:arguments[2],max:arguments[3],step:arguments[4]}):new is(e,t,{min:arguments[2],max:arguments[3]}):j.isString(n)?new Y_(e,t):j.isFunction(n)?new wc(e,t,""):j.isBoolean(n)?new Tc(e,t):null};function Q_(i){setTimeout(i,1e3/60)}var eg=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||Q_,tg=function(){function i(){ln(this,i),this.backgroundElement=document.createElement("div"),j.extend(this.backgroundElement.style,{backgroundColor:"rgba(0,0,0,0.8)",top:0,left:0,display:"none",zIndex:"1000",opacity:0,WebkitTransition:"opacity 0.2s linear",transition:"opacity 0.2s linear"}),N.makeFullscreen(this.backgroundElement),this.backgroundElement.style.position="fixed",this.domElement=document.createElement("div"),j.extend(this.domElement.style,{position:"fixed",display:"none",zIndex:"1001",opacity:0,WebkitTransition:"-webkit-transform 0.2s ease-out, opacity 0.2s linear",transition:"transform 0.2s ease-out, opacity 0.2s linear"}),document.body.appendChild(this.backgroundElement),document.body.appendChild(this.domElement);var e=this;N.bind(this.backgroundElement,"click",function(){e.hide()})}return cn(i,[{key:"show",value:function(){var t=this;this.backgroundElement.style.display="block",this.domElement.style.display="block",this.domElement.style.opacity=0,this.domElement.style.webkitTransform="scale(1.1)",this.layout(),j.defer(function(){t.backgroundElement.style.opacity=1,t.domElement.style.opacity=1,t.domElement.style.webkitTransform="scale(1)"})}},{key:"hide",value:function(){var t=this,n=function r(){t.domElement.style.display="none",t.backgroundElement.style.display="none",N.unbind(t.domElement,"webkitTransitionEnd",r),N.unbind(t.domElement,"transitionend",r),N.unbind(t.domElement,"oTransitionEnd",r)};N.bind(this.domElement,"webkitTransitionEnd",n),N.bind(this.domElement,"transitionend",n),N.bind(this.domElement,"oTransitionEnd",n),this.backgroundElement.style.opacity=0,this.domElement.style.opacity=0,this.domElement.style.webkitTransform="scale(1.1)"}},{key:"layout",value:function(){this.domElement.style.left=window.innerWidth/2-N.getWidth(this.domElement)/2+"px",this.domElement.style.top=window.innerHeight/2-N.getHeight(this.domElement)/2+"px"}}]),i}(),ng=H_(`.dg ul{list-style:none;margin:0;padding:0;width:100%;clear:both}.dg.ac{position:fixed;top:0;left:0;right:0;height:0;z-index:0}.dg:not(.ac) .main{overflow:hidden}.dg.main{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear}.dg.main.taller-than-window{overflow-y:auto}.dg.main.taller-than-window .close-button{opacity:1;margin-top:-1px;border-top:1px solid #2c2c2c}.dg.main ul.closed .close-button{opacity:1 !important}.dg.main:hover .close-button,.dg.main .close-button.drag{opacity:1}.dg.main .close-button{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear;border:0;line-height:19px;height:20px;cursor:pointer;text-align:center;background-color:#000}.dg.main .close-button.close-top{position:relative}.dg.main .close-button.close-bottom{position:absolute}.dg.main .close-button:hover{background-color:#111}.dg.a{float:right;margin-right:15px;overflow-y:visible}.dg.a.has-save>ul.close-top{margin-top:0}.dg.a.has-save>ul.close-bottom{margin-top:27px}.dg.a.has-save>ul.closed{margin-top:0}.dg.a .save-row{top:0;z-index:1002}.dg.a .save-row.close-top{position:relative}.dg.a .save-row.close-bottom{position:fixed}.dg li{-webkit-transition:height .1s ease-out;-o-transition:height .1s ease-out;-moz-transition:height .1s ease-out;transition:height .1s ease-out;-webkit-transition:overflow .1s linear;-o-transition:overflow .1s linear;-moz-transition:overflow .1s linear;transition:overflow .1s linear}.dg li:not(.folder){cursor:auto;height:27px;line-height:27px;padding:0 4px 0 5px}.dg li.folder{padding:0;border-left:4px solid rgba(0,0,0,0)}.dg li.title{cursor:pointer;margin-left:-4px}.dg .closed li:not(.title),.dg .closed ul li,.dg .closed ul li>*{height:0;overflow:hidden;border:0}.dg .cr{clear:both;padding-left:3px;height:27px;overflow:hidden}.dg .property-name{cursor:default;float:left;clear:left;width:40%;overflow:hidden;text-overflow:ellipsis}.dg .cr.function .property-name{width:100%}.dg .c{float:left;width:60%;position:relative}.dg .c input[type=text]{border:0;margin-top:4px;padding:3px;width:100%;float:right}.dg .has-slider input[type=text]{width:30%;margin-left:0}.dg .slider{float:left;width:66%;margin-left:-5px;margin-right:0;height:19px;margin-top:4px}.dg .slider-fg{height:100%}.dg .c input[type=checkbox]{margin-top:7px}.dg .c select{margin-top:5px}.dg .cr.function,.dg .cr.function .property-name,.dg .cr.function *,.dg .cr.boolean,.dg .cr.boolean *{cursor:pointer}.dg .cr.color{overflow:visible}.dg .selector{display:none;position:absolute;margin-left:-9px;margin-top:23px;z-index:10}.dg .c:hover .selector,.dg .selector.drag{display:block}.dg li.save-row{padding:0}.dg li.save-row .button{display:inline-block;padding:0px 6px}.dg.dialogue{background-color:#222;width:460px;padding:15px;font-size:13px;line-height:15px}#dg-new-constructor{padding:10px;color:#222;font-family:Monaco, monospace;font-size:10px;border:0;resize:none;box-shadow:inset 1px 1px 1px #888;word-wrap:break-word;margin:12px 0;display:block;width:440px;overflow-y:scroll;height:100px;position:relative}#dg-local-explain{display:none;font-size:11px;line-height:17px;border-radius:3px;background-color:#333;padding:8px;margin-top:10px}#dg-local-explain code{font-size:10px}#dat-gui-save-locally{display:none}.dg{color:#eee;font:11px 'Lucida Grande', sans-serif;text-shadow:0 -1px 0 #111}.dg.main::-webkit-scrollbar{width:5px;background:#1a1a1a}.dg.main::-webkit-scrollbar-corner{height:0;display:none}.dg.main::-webkit-scrollbar-thumb{border-radius:5px;background:#676767}.dg li:not(.folder){background:#1a1a1a;border-bottom:1px solid #2c2c2c}.dg li.save-row{line-height:25px;background:#dad5cb;border:0}.dg li.save-row select{margin-left:5px;width:108px}.dg li.save-row .button{margin-left:5px;margin-top:1px;border-radius:2px;font-size:9px;line-height:7px;padding:4px 4px 5px 4px;background:#c5bdad;color:#fff;text-shadow:0 1px 0 #b0a58f;box-shadow:0 -1px 0 #b0a58f;cursor:pointer}.dg li.save-row .button.gears{background:#c5bdad url(data:image/png;base64,) 2px 1px no-repeat;height:7px;width:8px}.dg li.save-row .button:hover{background-color:#bab19e;box-shadow:0 -1px 0 #b0a58f}.dg li.folder{border-bottom:0}.dg li.title{padding-left:16px;background:#000 url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlI+hKgFxoCgAOw==) 6px 10px no-repeat;cursor:pointer;border-bottom:1px solid rgba(255,255,255,0.2)}.dg .closed li.title{background-image:url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlGIWqMCbWAEAOw==)}.dg .cr.boolean{border-left:3px solid #806787}.dg .cr.color{border-left:3px solid}.dg .cr.function{border-left:3px solid #e61d5f}.dg .cr.number{border-left:3px solid #2FA1D6}.dg .cr.number input[type=text]{color:#2FA1D6}.dg .cr.string{border-left:3px solid #1ed36f}.dg .cr.string input[type=text]{color:#1ed36f}.dg .cr.function:hover,.dg .cr.boolean:hover{background:#111}.dg .c input[type=text]{background:#303030;outline:none}.dg .c input[type=text]:hover{background:#3c3c3c}.dg .c input[type=text]:focus{background:#494949;color:#fff}.dg .c .slider{background:#303030;cursor:ew-resize}.dg .c .slider-fg{background:#2FA1D6;max-width:100%}.dg .c .slider:hover{background:#3c3c3c}.dg .c .slider:hover .slider-fg{background:#44abda}
`);$_.inject(ng);var Ll="dg",Pl=72,Dl=20,_r="Default",rr=function(){try{return!!window.localStorage}catch{return!1}}(),ur=void 0,Ul=!0,Pi=void 0,qs=!1,Rc=[],qe=function i(e){var t=this,n=e||{};this.domElement=document.createElement("div"),this.__ul=document.createElement("ul"),this.domElement.appendChild(this.__ul),N.addClass(this.domElement,Ll),this.__folders={},this.__controllers=[],this.__rememberedObjects=[],this.__rememberedObjectIndecesToControllers=[],this.__listening=[],n=j.defaults(n,{closeOnTop:!1,autoPlace:!0,width:i.DEFAULT_WIDTH}),n=j.defaults(n,{resizable:n.autoPlace,hideable:n.autoPlace}),j.isUndefined(n.load)?n.load={preset:_r}:n.preset&&(n.load.preset=n.preset),j.isUndefined(n.parent)&&n.hideable&&Rc.push(this),n.resizable=j.isUndefined(n.parent)&&n.resizable,n.autoPlace&&j.isUndefined(n.scrollable)&&(n.scrollable=!0);var r=rr&&localStorage.getItem(Di(this,"isLocal"))==="true",s=void 0,o=void 0;if(Object.defineProperties(this,{parent:{get:function(){return n.parent}},scrollable:{get:function(){return n.scrollable}},autoPlace:{get:function(){return n.autoPlace}},closeOnTop:{get:function(){return n.closeOnTop}},preset:{get:function(){return t.parent?t.getRoot().preset:n.load.preset},set:function(f){t.parent?t.getRoot().preset=f:n.load.preset=f,ag(this),t.revert()}},width:{get:function(){return n.width},set:function(f){n.width=f,ua(t,f)}},name:{get:function(){return n.name},set:function(f){n.name=f,o&&(o.innerHTML=n.name)}},closed:{get:function(){return n.closed},set:function(f){n.closed=f,n.closed?N.addClass(t.__ul,i.CLASS_CLOSED):N.removeClass(t.__ul,i.CLASS_CLOSED),this.onResize(),t.__closeButton&&(t.__closeButton.innerHTML=f?i.TEXT_OPEN:i.TEXT_CLOSED)}},load:{get:function(){return n.load}},useLocalStorage:{get:function(){return r},set:function(f){rr&&(r=f,f?N.bind(window,"unload",s):N.unbind(window,"unload",s),localStorage.setItem(Di(t,"isLocal"),f))}}}),j.isUndefined(n.parent)){if(this.closed=n.closed||!1,N.addClass(this.domElement,i.CLASS_MAIN),N.makeSelectable(this.domElement,!1),rr&&r){t.useLocalStorage=!0;var a=localStorage.getItem(Di(this,"gui"));a&&(n.load=JSON.parse(a))}this.__closeButton=document.createElement("div"),this.__closeButton.innerHTML=i.TEXT_CLOSED,N.addClass(this.__closeButton,i.CLASS_CLOSE_BUTTON),n.closeOnTop?(N.addClass(this.__closeButton,i.CLASS_CLOSE_TOP),this.domElement.insertBefore(this.__closeButton,this.domElement.childNodes[0])):(N.addClass(this.__closeButton,i.CLASS_CLOSE_BOTTOM),this.domElement.appendChild(this.__closeButton)),N.bind(this.__closeButton,"click",function(){t.closed=!t.closed})}else{n.closed===void 0&&(n.closed=!0);var l=document.createTextNode(n.name);N.addClass(l,"controller-name"),o=Ra(t,l);var c=function(f){return f.preventDefault(),t.closed=!t.closed,!1};N.addClass(this.__ul,i.CLASS_CLOSED),N.addClass(o,"title"),N.bind(o,"click",c),n.closed||(this.closed=!1)}n.autoPlace&&(j.isUndefined(n.parent)&&(Ul&&(Pi=document.createElement("div"),N.addClass(Pi,Ll),N.addClass(Pi,i.CLASS_AUTO_PLACE_CONTAINER),document.body.appendChild(Pi),Ul=!1),Pi.appendChild(this.domElement),N.addClass(this.domElement,i.CLASS_AUTO_PLACE)),this.parent||ua(t,n.width)),this.__resizeHandler=function(){t.onResizeDebounced()},N.bind(window,"resize",this.__resizeHandler),N.bind(this.__ul,"webkitTransitionEnd",this.__resizeHandler),N.bind(this.__ul,"transitionend",this.__resizeHandler),N.bind(this.__ul,"oTransitionEnd",this.__resizeHandler),this.onResize(),n.resizable&&sg(this),s=function(){rr&&localStorage.getItem(Di(t,"isLocal"))==="true"&&localStorage.setItem(Di(t,"gui"),JSON.stringify(t.getSaveObject()))},this.saveToLocalStorageIfPossible=s;function u(){var h=t.getRoot();h.width+=1,j.defer(function(){h.width-=1})}n.parent||u()};qe.toggleHide=function(){qs=!qs,j.each(Rc,function(i){i.domElement.style.display=qs?"none":""})};qe.CLASS_AUTO_PLACE="a";qe.CLASS_AUTO_PLACE_CONTAINER="ac";qe.CLASS_MAIN="main";qe.CLASS_CONTROLLER_ROW="cr";qe.CLASS_TOO_TALL="taller-than-window";qe.CLASS_CLOSED="closed";qe.CLASS_CLOSE_BUTTON="close-button";qe.CLASS_CLOSE_TOP="close-top";qe.CLASS_CLOSE_BOTTOM="close-bottom";qe.CLASS_DRAG="drag";qe.DEFAULT_WIDTH=245;qe.TEXT_CLOSED="Close Controls";qe.TEXT_OPEN="Open Controls";qe._keydownHandler=function(i){document.activeElement.type!=="text"&&(i.which===Pl||i.keyCode===Pl)&&qe.toggleHide()};N.bind(window,"keydown",qe._keydownHandler,!1);j.extend(qe.prototype,{add:function(e,t){return hr(this,e,t,{factoryArgs:Array.prototype.slice.call(arguments,2)})},addColor:function(e,t){return hr(this,e,t,{color:!0})},remove:function(e){this.__ul.removeChild(e.__li),this.__controllers.splice(this.__controllers.indexOf(e),1);var t=this;j.defer(function(){t.onResize()})},destroy:function(){if(this.parent)throw new Error("Only the root GUI should be removed with .destroy(). For subfolders, use gui.removeFolder(folder) instead.");this.autoPlace&&Pi.removeChild(this.domElement);var e=this;j.each(this.__folders,function(t){e.removeFolder(t)}),N.unbind(window,"keydown",qe._keydownHandler,!1),Il(this)},addFolder:function(e){if(this.__folders[e]!==void 0)throw new Error('You already have a folder in this GUI by the name "'+e+'"');var t={name:e,parent:this};t.autoPlace=this.autoPlace,this.load&&this.load.folders&&this.load.folders[e]&&(t.closed=this.load.folders[e].closed,t.load=this.load.folders[e]);var n=new qe(t);this.__folders[e]=n;var r=Ra(this,n.domElement);return N.addClass(r,"folder"),n},removeFolder:function(e){this.__ul.removeChild(e.domElement.parentElement),delete this.__folders[e.name],this.load&&this.load.folders&&this.load.folders[e.name]&&delete this.load.folders[e.name],Il(e);var t=this;j.each(e.__folders,function(n){e.removeFolder(n)}),j.defer(function(){t.onResize()})},open:function(){this.closed=!1},close:function(){this.closed=!0},hide:function(){this.domElement.style.display="none"},show:function(){this.domElement.style.display=""},onResize:function(){var e=this.getRoot();if(e.scrollable){var t=N.getOffset(e.__ul).top,n=0;j.each(e.__ul.childNodes,function(r){e.autoPlace&&r===e.__save_row||(n+=N.getHeight(r))}),window.innerHeight-t-Dl<n?(N.addClass(e.domElement,qe.CLASS_TOO_TALL),e.__ul.style.height=window.innerHeight-t-Dl+"px"):(N.removeClass(e.domElement,qe.CLASS_TOO_TALL),e.__ul.style.height="auto")}e.__resize_handle&&j.defer(function(){e.__resize_handle.style.height=e.__ul.offsetHeight+"px"}),e.__closeButton&&(e.__closeButton.style.width=e.width+"px")},onResizeDebounced:j.debounce(function(){this.onResize()},50),remember:function(){if(j.isUndefined(ur)&&(ur=new tg,ur.domElement.innerHTML=J_),this.parent)throw new Error("You can only call remember on a top level GUI.");var e=this;j.each(Array.prototype.slice.call(arguments),function(t){e.__rememberedObjects.length===0&&rg(e),e.__rememberedObjects.indexOf(t)===-1&&e.__rememberedObjects.push(t)}),this.autoPlace&&ua(this,this.width)},getRoot:function(){for(var e=this;e.parent;)e=e.parent;return e},getSaveObject:function(){var e=this.load;return e.closed=this.closed,this.__rememberedObjects.length>0&&(e.preset=this.preset,e.remembered||(e.remembered={}),e.remembered[this.preset]=$r(this)),e.folders={},j.each(this.__folders,function(t,n){e.folders[n]=t.getSaveObject()}),e},save:function(){this.load.remembered||(this.load.remembered={}),this.load.remembered[this.preset]=$r(this),la(this,!1),this.saveToLocalStorageIfPossible()},saveAs:function(e){this.load.remembered||(this.load.remembered={},this.load.remembered[_r]=$r(this,!0)),this.load.remembered[e]=$r(this),this.preset=e,ca(this,e,!0),this.saveToLocalStorageIfPossible()},revert:function(e){j.each(this.__controllers,function(t){this.getRoot().load.remembered?Cc(e||this.getRoot(),t):t.setValue(t.initialValue),t.__onFinishChange&&t.__onFinishChange.call(t,t.getValue())},this),j.each(this.__folders,function(t){t.revert(t)}),e||la(this.getRoot(),!1)},listen:function(e){var t=this.__listening.length===0;this.__listening.push(e),t&&Lc(this.__listening)},updateDisplay:function(){j.each(this.__controllers,function(e){e.updateDisplay()}),j.each(this.__folders,function(e){e.updateDisplay()})}});function Ra(i,e,t){var n=document.createElement("li");return e&&n.appendChild(e),t?i.__ul.insertBefore(n,t):i.__ul.appendChild(n),i.onResize(),n}function Il(i){N.unbind(window,"resize",i.__resizeHandler),i.saveToLocalStorageIfPossible&&N.unbind(window,"unload",i.saveToLocalStorageIfPossible)}function la(i,e){var t=i.__preset_select[i.__preset_select.selectedIndex];e?t.innerHTML=t.value+"*":t.innerHTML=t.value}function ig(i,e,t){if(t.__li=e,t.__gui=i,j.extend(t,{options:function(o){if(arguments.length>1){var a=t.__li.nextElementSibling;return t.remove(),hr(i,t.object,t.property,{before:a,factoryArgs:[j.toArray(arguments)]})}if(j.isArray(o)||j.isObject(o)){var l=t.__li.nextElementSibling;return t.remove(),hr(i,t.object,t.property,{before:l,factoryArgs:[o]})}},name:function(o){return t.__li.firstElementChild.firstElementChild.innerHTML=o,t},listen:function(){return t.__gui.listen(t),t},remove:function(){return t.__gui.remove(t),t}}),t instanceof aa){var n=new is(t.object,t.property,{min:t.__min,max:t.__max,step:t.__step});j.each(["updateDisplay","onChange","onFinishChange","step","min","max"],function(s){var o=t[s],a=n[s];t[s]=n[s]=function(){var l=Array.prototype.slice.call(arguments);return a.apply(n,l),o.apply(t,l)}}),N.addClass(e,"has-slider"),t.domElement.insertBefore(n.domElement,t.domElement.firstElementChild)}else if(t instanceof is){var r=function(o){if(j.isNumber(t.__min)&&j.isNumber(t.__max)){var a=t.__li.firstElementChild.firstElementChild.innerHTML,l=t.__gui.__listening.indexOf(t)>-1;t.remove();var c=hr(i,t.object,t.property,{before:t.__li.nextElementSibling,factoryArgs:[t.__min,t.__max,t.__step]});return c.name(a),l&&c.listen(),c}return o};t.min=j.compose(r,t.min),t.max=j.compose(r,t.max)}else t instanceof Tc?(N.bind(e,"click",function(){N.fakeEvent(t.__checkbox,"click")}),N.bind(t.__checkbox,"click",function(s){s.stopPropagation()})):t instanceof wc?(N.bind(e,"click",function(){N.fakeEvent(t.__button,"click")}),N.bind(e,"mouseover",function(){N.addClass(t.__button,"hover")}),N.bind(e,"mouseout",function(){N.removeClass(t.__button,"hover")})):t instanceof oa&&(N.addClass(e,"color"),t.updateDisplay=j.compose(function(s){return e.style.borderLeftColor=t.__color.toString(),s},t.updateDisplay),t.updateDisplay());t.setValue=j.compose(function(s){return i.getRoot().__preset_select&&t.isModified()&&la(i.getRoot(),!0),s},t.setValue)}function Cc(i,e){var t=i.getRoot(),n=t.__rememberedObjects.indexOf(e.object);if(n!==-1){var r=t.__rememberedObjectIndecesToControllers[n];if(r===void 0&&(r={},t.__rememberedObjectIndecesToControllers[n]=r),r[e.property]=e,t.load&&t.load.remembered){var s=t.load.remembered,o=void 0;if(s[i.preset])o=s[i.preset];else if(s[_r])o=s[_r];else return;if(o[n]&&o[n][e.property]!==void 0){var a=o[n][e.property];e.initialValue=a,e.setValue(a)}}}}function hr(i,e,t,n){if(e[t]===void 0)throw new Error('Object "'+e+'" has no property "'+t+'"');var r=void 0;if(n.color)r=new oa(e,t);else{var s=[e,t].concat(n.factoryArgs);r=Z_.apply(i,s)}n.before instanceof ui&&(n.before=n.before.__li),Cc(i,r),N.addClass(r.domElement,"c");var o=document.createElement("span");N.addClass(o,"property-name"),o.innerHTML=r.property;var a=document.createElement("div");a.appendChild(o),a.appendChild(r.domElement);var l=Ra(i,a,n.before);return N.addClass(l,qe.CLASS_CONTROLLER_ROW),r instanceof oa?N.addClass(l,"color"):N.addClass(l,G_(r.getValue())),ig(i,l,r),i.__controllers.push(r),r}function Di(i,e){return document.location.href+"."+e}function ca(i,e,t){var n=document.createElement("option");n.innerHTML=e,n.value=e,i.__preset_select.appendChild(n),t&&(i.__preset_select.selectedIndex=i.__preset_select.length-1)}function Nl(i,e){e.style.display=i.useLocalStorage?"block":"none"}function rg(i){var e=i.__save_row=document.createElement("li");N.addClass(i.domElement,"has-save"),i.__ul.insertBefore(e,i.__ul.firstChild),N.addClass(e,"save-row");var t=document.createElement("span");t.innerHTML="&nbsp;",N.addClass(t,"button gears");var n=document.createElement("span");n.innerHTML="Save",N.addClass(n,"button"),N.addClass(n,"save");var r=document.createElement("span");r.innerHTML="New",N.addClass(r,"button"),N.addClass(r,"save-as");var s=document.createElement("span");s.innerHTML="Revert",N.addClass(s,"button"),N.addClass(s,"revert");var o=i.__preset_select=document.createElement("select");if(i.load&&i.load.remembered?j.each(i.load.remembered,function(h,f){ca(i,f,f===i.preset)}):ca(i,_r,!1),N.bind(o,"change",function(){for(var h=0;h<i.__preset_select.length;h++)i.__preset_select[h].innerHTML=i.__preset_select[h].value;i.preset=this.value}),e.appendChild(o),e.appendChild(t),e.appendChild(n),e.appendChild(r),e.appendChild(s),rr){var a=document.getElementById("dg-local-explain"),l=document.getElementById("dg-local-storage"),c=document.getElementById("dg-save-locally");c.style.display="block",localStorage.getItem(Di(i,"isLocal"))==="true"&&l.setAttribute("checked","checked"),Nl(i,a),N.bind(l,"change",function(){i.useLocalStorage=!i.useLocalStorage,Nl(i,a)})}var u=document.getElementById("dg-new-constructor");N.bind(u,"keydown",function(h){h.metaKey&&(h.which===67||h.keyCode===67)&&ur.hide()}),N.bind(t,"click",function(){u.innerHTML=JSON.stringify(i.getSaveObject(),void 0,2),ur.show(),u.focus(),u.select()}),N.bind(n,"click",function(){i.save()}),N.bind(r,"click",function(){var h=prompt("Enter a new preset name.");h&&i.saveAs(h)}),N.bind(s,"click",function(){i.revert()})}function sg(i){var e=void 0;i.__resize_handle=document.createElement("div"),j.extend(i.__resize_handle.style,{width:"6px",marginLeft:"-3px",height:"200px",cursor:"ew-resize",position:"absolute"});function t(s){return s.preventDefault(),i.width+=e-s.clientX,i.onResize(),e=s.clientX,!1}function n(){N.removeClass(i.__closeButton,qe.CLASS_DRAG),N.unbind(window,"mousemove",t),N.unbind(window,"mouseup",n)}function r(s){return s.preventDefault(),e=s.clientX,N.addClass(i.__closeButton,qe.CLASS_DRAG),N.bind(window,"mousemove",t),N.bind(window,"mouseup",n),!1}N.bind(i.__resize_handle,"mousedown",r),N.bind(i.__closeButton,"mousedown",r),i.domElement.insertBefore(i.__resize_handle,i.domElement.firstElementChild)}function ua(i,e){i.domElement.style.width=e+"px",i.__save_row&&i.autoPlace&&(i.__save_row.style.width=e+"px"),i.__closeButton&&(i.__closeButton.style.width=e+"px")}function $r(i,e){var t={};return j.each(i.__rememberedObjects,function(n,r){var s={},o=i.__rememberedObjectIndecesToControllers[r];j.each(o,function(a,l){s[l]=e?a.initialValue:a.getValue()}),t[r]=s}),t}function ag(i){for(var e=0;e<i.__preset_select.length;e++)i.__preset_select[e].value===i.preset&&(i.__preset_select.selectedIndex=e)}function Lc(i){i.length!==0&&eg.call(window,function(){Lc(i)}),j.each(i,function(e){e.updateDisplay()})}var og=qe,Gi=new Mc;const lg=document.getElementById("progress-bar");Gi.onProgress=function(i,e,t){lg.value=e/t*100};const cg=document.querySelector(".progress-bar-container");Gi.onLoad=function(){cg.style.display="none"};let Xe,Yt,Yi,Vn;Yt=new d_;const xt={width:window.innerWidth,height:window.innerHeight,pixelRatio:window.devicePixelRatio},ug=xt.width/xt.height;Xe=new Bt(60,ug,.1,1e4);Xe.position.set(-100,80,250);Yt.add(Xe);Yi=new mc({antialias:!0});Yi.setSize(xt.width,xt.height);Yi.setPixelRatio(xt.pixelRatio);document.body.appendChild(Yi.domElement);Vn=new z_({antialias:!0});Vn.setSize(xt.width,xt.height);Vn.domElement.style.position="absolute";Vn.domElement.style.top="0px";document.body.appendChild(Vn.domElement);const qi=new B_(Xe,Vn.domElement);qi.minDistance=20;qi.maxDistance=2e4;qi.enableDamping=!0;qi.enablePan=!0;qi.update;const hg=new F_(3355443),dg=new O_(16777215,5,400);Yt.add(hg,dg);const F={sunSize:15,mercuryDist:25,earthRot:.05,earthRev:.005,slowRate:1};window.addEventListener("mousedown",function(i){const e=xt.width-Vi.__ul.clientWidth-25,t=Vi.__ul.clientHeight+25;(i.clientX<e||i.clientY>t)&&(F.slowRate=.2,Wn.style.opacity=1,Tg(),Ag(),(tt.mercury||tt.venus||tt.earth||tt.mars||tt.jupiter||tt.saturn||tt.uranus||tt.neptune==!0)&&Rg())});window.addEventListener("mouseup",()=>(F.slowRate=1,Wn.style.opacity=0,Vc(),wg(),Wc()));const Pc=new zt,Dc=5e5,Uc=new Float32Array(Dc*3);for(let i=0;i<Dc*3;i++)Uc[i]=(Math.random()-.5)*4e4;Pc.setAttribute("position",new on(Uc,3));const fg=new gc({size:.005}),pg=new p_(Pc,fg);Yt.add(pg);const mg=new yr(F.sunSize,64,64),Ic=new ia(Gi).load("sun.jpg"),_g=new Hi({map:Ic}),Nc=new Xt(mg,_g);Yt.add(Nc);const gg=new yr(F.sunSize+.1,64,64),vg=new Hi({map:Ic,transparent:!0,opacity:.2}),Oc=new Xt(gg,vg);Yt.add(Oc);const Fc=new ot,Wn=document.createElement("div");Wn.className="label";Wn.textContent="Sun";Wn.style.backgroundColor="transparent";Wn.style.opacity=0;const Ca=new ra(Wn);Ca.position.set(F.sunSize/1.5,F.sunSize/1.1,0);Ca.center.set(0,1);Fc.add(Ca);Yt.add(Fc);function Xn(i){const e=new C_().absarc(0,0,i,0,2*Math.PI).getPoints(500),t=new zt().setFromPoints(e),n=new _c({color:16777215,transparent:!0,opacity:.4}),r=new f_(t,n);return r.rotation.x=Math.PI/2,Yt.add(r),{mesh:r,material:n}}const La=Xn(1*F.mercuryDist),Pa=Xn(1.9*F.mercuryDist),Da=Xn(2.6*F.mercuryDist),Ua=Xn(4*F.mercuryDist),Ia=Xn(5.5*F.mercuryDist),Na=Xn(7.2*F.mercuryDist),Oa=Xn(8.4*F.mercuryDist),Fa=Xn(9.9*F.mercuryDist);Vc();function yt(i,e,t,n,r,s){const o=new yr(e,30,30),a=new ia(Gi).load(n);var l=0,c=0,u=0;if(r)var l=new Hi({map:a});else var l=new P_({map:a});var h=new Xt(o,l);const f=new ot;var m=0;if(s){const _=new ia(Gi).load(s.texture),g=new Ea(s.innerRadius,s.outerRadius,32);if(r)var c=new Hi({map:_,side:rn,transparent:!0});else var c=new L_({map:_,side:rn,transparent:!0});var m=new Xt(g,c);f.add(m),m.position.x=t,m.rotation.x=Math.PI/2}if(f.add(h),Yt.add(f),h.position.x=t,r){var u=document.createElement("div");u.className="labelAlt",u.textContent=i,u.style.backgroundColor="transparent",u.style.opacity=0;const g=new ra(u);g.position.set(0,0,0),g.center.set(0,3),h.add(g)}else{var u=document.createElement("div");u.className="label",u.textContent=i,u.style.backgroundColor="transparent",u.style.opacity=0;const g=new ra(u);g.position.set(0,0,0),g.center.set(0,1.5),h.add(g)}return{mesh:h,obj:f,ringmesh:m,label:u}}const kt=yt("Mercury",.04*F.sunSize,1*F.mercuryDist,"mercury.jpg",!1),Zt=yt("Venus",.09*F.sunSize,1.9*F.mercuryDist,"venus.jpg",!1),Qt=yt("Earth",.1*F.sunSize,2.6*F.mercuryDist,"earth.jpg",!1),en=yt("Mars",.05*F.sunSize,4*F.mercuryDist,"mars.jpg",!1),tn=yt("Jupiter",.25*F.sunSize,5.5*F.mercuryDist,"jupiter.jpg"),Gt=yt("Saturn",.23*F.sunSize,7.2*F.mercuryDist,"saturn.jpg",!1,{innerRadius:F.sunSize/4,outerRadius:F.sunSize/2,texture:"saturnring.png"}),Vt=yt("Uranus",.18*F.sunSize,8.4*F.mercuryDist,"uranus.jpg",!1,{innerRadius:F.sunSize/6,outerRadius:F.sunSize/3,texture:"uranusring.png"}),fn=yt("Neptune",.17*F.sunSize,9.9*F.mercuryDist,"neptune.jpg",!1),Et=yt("Mercury",.04*F.sunSize,1*F.mercuryDist,"mercury.jpg",!0),Tt=yt("Venus",.09*F.sunSize,1.9*F.mercuryDist,"venus.jpg",!0),At=yt("Earth",.1*F.sunSize,2.6*F.mercuryDist,"earth.jpg",!0),wt=yt("Mars",.05*F.sunSize,4*F.mercuryDist,"mars.jpg",!0),Rt=yt("Jupiter",.25*F.sunSize,5.5*F.mercuryDist,"jupiter.jpg",!0),gt=yt("Saturn",.23*F.sunSize,7.2*F.mercuryDist,"saturn.jpg",!0,{innerRadius:F.sunSize/4,outerRadius:F.sunSize/2,texture:"saturnring.png"}),vt=yt("Uranus",.18*F.sunSize,8.4*F.mercuryDist,"uranus.jpg",!0,{innerRadius:F.sunSize/6,outerRadius:F.sunSize/3,texture:"uranusring.png"}),Ct=yt("Neptune",.17*F.sunSize,9.9*F.mercuryDist,"neptune.jpg",!0);dn();kt.obj.rotateY(Cn.randInt(-4,4)*Math.PI/2);Zt.obj.rotateY(Cn.randInt(-4,4)*Math.PI/2);Qt.obj.rotateY(Cn.randInt(-4,4)*Math.PI/2);en.obj.rotateY(Cn.randInt(-4,4)*Math.PI/2);tn.obj.rotateY(Cn.randInt(-4,4)*Math.PI/2);Gt.obj.rotateY(Cn.randInt(-4,4)*Math.PI/2);Vt.obj.rotateY(Cn.randInt(-4,4)*Math.PI/2);function gn(i){const e=Math.sin(Cn.degToRad(i)),t=Math.cos(Cn.degToRad(i));var n=new R(e,t,0);return n}var xg=gn(7.25),yg=gn(7.25),Ol=gn(.03),Fl=gn(177.3),Bl=gn(23.5),zl=gn(25.2),Hl=gn(3.13),Jr=gn(26.7),Zr=gn(97.8),kl=gn(28.3);window.addEventListener("resize",()=>{xt.width=window.innerWidth,xt.height=window.innerHeight,Xe.aspect=xt.width/xt.height,Xe.updateProjectionMatrix(),Yi.setSize(xt.width,xt.height),Vn.setSize(xt.width,xt.height)});const Mg=new U_(Gi).load(["stars.jpg","stars.jpg","stars.jpg","stars.jpg","stars.jpg","stars.jpg"]);Yt.background=Mg;const Sg={reset:function(){F.earthRot=.05,F.earthRev=.005}},Bc={reset:function(){Xe.position.x=-100,Xe.position.y=120,Xe.position.z=250}},tt={mercury:!1,venus:!1,earth:!1,mars:!1,jupiter:!1,saturn:!1,uranus:!1,neptune:!1,default:!1};function bg(i){for(let e in tt)tt[e]=!1;tt[i]=!0,tt.default&&(F.slowRate=1,Bc.reset())}const Eg={options:"default"},zc={label:!1},Hc={label:!1},Vi=new og;let os=Vi.addFolder("speed");os.add(F,"earthRot",0,1,.001).name("rotation").listen();os.add(F,"earthRev",0,.1,.001).name("revolution").listen();os.add(Sg,"reset").name("reset");os.open();let Mr=Vi.addFolder("camera");Mr.add(Xe.position,"x",-300,300).listen();Mr.add(Xe.position,"y",-300,300).listen();Mr.add(Xe.position,"z",-300,300).listen();Mr.add(Bc,"reset").name("reset");Mr.open();let kc=Vi.addFolder("planets");kc.add(Eg,"options",["default","mercury","venus","earth","mars","jupiter","saturn","uranus","neptune"]).name("view").listen().onChange(i=>bg(i));kc.open();let Ba=Vi.addFolder("labels");Ba.add(zc,"label").name("orbit").listen();Ba.add(Hc,"label").name("planet name").listen();Ba.open();const Gc=()=>{if(tt.default){Tn(),dn(),Wc();const i=new R(0,0,0);Xe.lookAt(i)}if(tt.mercury){F.slowRate=.2,Tn(kt),dn(Et),kt.label.style.opacity=0,Tt.label.style.opacity=0,At.label.style.opacity=0,wt.label.style.opacity=0,Rt.label.style.opacity=0,gt.label.style.opacity=0,vt.label.style.opacity=0,Ct.label.style.opacity=0;const i=new R(F.mercuryDist,0,0),e=new R(1.2*F.mercuryDist,2,7);Xe.position.lerp(e,.01),Xe.lookAt(i)}if(tt.venus){F.slowRate=.2,Tn(Zt),dn(Tt),Zt.label.style.opacity=0,Et.label.style.opacity=0,At.label.style.opacity=0,wt.label.style.opacity=0,Rt.label.style.opacity=0,gt.label.style.opacity=0,vt.label.style.opacity=0,Ct.label.style.opacity=0;const i=new R(1.9*F.mercuryDist,0,0),e=new R(1.2*1.9*F.mercuryDist,2,7);Xe.position.lerp(e,.01),Xe.lookAt(i)}if(tt.earth){F.slowRate=.2,Tn(Qt),dn(At),Qt.label.style.opacity=0,Et.label.style.opacity=0,Tt.label.style.opacity=0,wt.label.style.opacity=0,Rt.label.style.opacity=0,gt.label.style.opacity=0,vt.label.style.opacity=0,Ct.label.style.opacity=0;const i=new R(2.6*F.mercuryDist,0,0),e=new R(1.2*2.6*F.mercuryDist,2,7);Xe.position.lerp(e,.01),Xe.lookAt(i)}if(tt.mars){F.slowRate=.2,Tn(en),dn(wt),en.label.style.opacity=0,Et.label.style.opacity=0,Tt.label.style.opacity=0,At.label.style.opacity=0,Rt.label.style.opacity=0,gt.label.style.opacity=0,vt.label.style.opacity=0,Ct.label.style.opacity=0;const i=new R(4*F.mercuryDist,0,0),e=new R(1.2*4*F.mercuryDist,2,7);Xe.position.lerp(e,.01),Xe.lookAt(i)}if(tt.jupiter){F.slowRate=.2,Tn(tn),dn(Rt),tn.label.style.opacity=0,Et.label.style.opacity=0,Tt.label.style.opacity=0,At.label.style.opacity=0,wt.label.style.opacity=0,gt.label.style.opacity=0,vt.label.style.opacity=0,Ct.label.style.opacity=0;const i=new R(5.5*F.mercuryDist,0,0),e=new R(1.2*5.5*F.mercuryDist,2,7);Xe.position.lerp(e,.01),Xe.lookAt(i)}if(tt.saturn){F.slowRate=.2,Tn(Gt),dn(gt),Gt.label.style.opacity=0,Et.label.style.opacity=0,Tt.label.style.opacity=0,At.label.style.opacity=0,wt.label.style.opacity=0,Rt.label.style.opacity=0,vt.label.style.opacity=0,Ct.label.style.opacity=0;const i=new R(7.2*F.mercuryDist,0,0),e=new R(1.2*7.2*F.mercuryDist,2,7);Xe.position.lerp(e,.01),Xe.lookAt(i)}if(tt.uranus){F.slowRate=.2,Tn(Vt),dn(vt),Vt.label.style.opacity=0,Et.label.style.opacity=0,Tt.label.style.opacity=0,At.label.style.opacity=0,wt.label.style.opacity=0,Rt.label.style.opacity=0,gt.label.style.opacity=0,Ct.label.style.opacity=0;const i=new R(8.4*F.mercuryDist,0,0),e=new R(1.2*8.4*F.mercuryDist,2,7);Xe.position.lerp(e,.01),Xe.lookAt(i)}if(tt.neptune){F.slowRate=.2,Tn(fn),dn(Ct),fn.label.style.opacity=0,Et.label.style.opacity=0,Tt.label.style.opacity=0,At.label.style.opacity=0,wt.label.style.opacity=0,Rt.label.style.opacity=0,gt.label.style.opacity=0,vt.label.style.opacity=0;const i=new R(9.9*F.mercuryDist,0,0),e=new R(1.2*9.9*F.mercuryDist,2,7);Xe.position.lerp(e,.01),Xe.lookAt(i)}zc.label&&(La.mesh.visible=!0,Pa.mesh.visible=!0,Da.mesh.visible=!0,Ua.mesh.visible=!0,Ia.mesh.visible=!0,Na.mesh.visible=!0,Oa.mesh.visible=!0,Fa.mesh.visible=!0),Hc.label&&(Wn.style.opacity=1,kt.obj.visible?kt.label.style.opacity=1:kt.label.style.opacity=0,Zt.obj.visible?Zt.label.style.opacity=1:Zt.label.style.opacity=0,Qt.obj.visible?Qt.label.style.opacity=1:Qt.label.style.opacity=0,en.obj.visible?en.label.style.opacity=1:en.label.style.opacity=0,tn.obj.visible?tn.label.style.opacity=1:tn.label.style.opacity=0,Gt.obj.visible?Gt.label.style.opacity=1:Gt.label.style.opacity=0,Vt.obj.visible?Vt.label.style.opacity=1:Vt.label.style.opacity=0,fn.obj.visible?fn.label.style.opacity=1:fn.label.style.opacity=0,Et.obj.visible?Et.label.style.opacity=1:Et.label.style.opacity=0,Tt.obj.visible?Tt.label.style.opacity=1:Tt.label.style.opacity=0,At.obj.visible?At.label.style.opacity=1:At.label.style.opacity=0,wt.obj.visible?wt.label.style.opacity=1:wt.label.style.opacity=0,Rt.obj.visible?Rt.label.style.opacity=1:Rt.label.style.opacity=0,gt.obj.visible?gt.label.style.opacity=1:gt.label.style.opacity=0,vt.obj.visible?vt.label.style.opacity=1:vt.label.style.opacity=0,Ct.obj.visible?Ct.label.style.opacity=1:Ct.label.style.opacity=0),Nc.rotateOnAxis(xg,.04*F.earthRot*F.slowRate),Oc.rotateOnAxis(yg,-.01*F.earthRot*F.slowRate),kt.mesh.rotateOnAxis(Ol,.02*F.earthRot*F.slowRate),Zt.mesh.rotateOnAxis(Fl,.004*F.earthRot*F.slowRate),Qt.mesh.rotateOnAxis(Bl,1*F.earthRot*F.slowRate),en.mesh.rotateOnAxis(zl,.9*F.earthRot*F.slowRate),tn.mesh.rotateOnAxis(Hl,2.4*F.earthRot*F.slowRate),Gt.mesh.rotateOnAxis(Jr,2.2*F.earthRot*F.slowRate),Gt.ringmesh.rotateOnAxis(Jr,.22*F.earthRot*F.slowRate),Vt.mesh.rotateOnAxis(Zr,1.4*F.earthRot*F.slowRate),Vt.ringmesh.rotateOnAxis(Zr,.14*F.earthRot*F.slowRate),fn.mesh.rotateOnAxis(kl,1.5*F.earthRot*F.slowRate),Et.mesh.rotateOnAxis(Ol,.02*F.earthRot*F.slowRate),Tt.mesh.rotateOnAxis(Fl,.004*F.earthRot*F.slowRate),At.mesh.rotateOnAxis(Bl,1*F.earthRot*F.slowRate),wt.mesh.rotateOnAxis(zl,.9*F.earthRot*F.slowRate),Rt.mesh.rotateOnAxis(Hl,2.4*F.earthRot*F.slowRate),gt.mesh.rotateOnAxis(Jr,2.2*F.earthRot*F.slowRate),gt.ringmesh.rotateOnAxis(Jr,.22*F.earthRot*F.slowRate),vt.mesh.rotateOnAxis(Zr,1.4*F.earthRot*F.slowRate),vt.ringmesh.rotateOnAxis(Zr,.14*F.earthRot*F.slowRate),Ct.mesh.rotateOnAxis(kl,1.5*F.earthRot*F.slowRate),kt.obj.rotateY(4.1*F.earthRev*F.slowRate),kt.obj.updateMatrixWorld(),Zt.obj.rotateY(1.6*F.earthRev*F.slowRate),Qt.obj.rotateY(1*F.earthRev*F.slowRate),en.obj.rotateY(.5*F.earthRev*F.slowRate),tn.obj.rotateY(.08*5*F.earthRev*F.slowRate),Gt.obj.rotateY(.03*5*F.earthRev*F.slowRate),Vt.obj.rotateY(.01*5*F.earthRev*F.slowRate),fn.obj.rotateY(.006*5*F.earthRev*F.slowRate),Yi.render(Yt,Xe),Vn.render(Yt,Xe),window.requestAnimationFrame(Gc),qi.update()};Gc();function Tg(){La.mesh.visible=!0,Pa.mesh.visible=!0,Da.mesh.visible=!0,Ua.mesh.visible=!0,Ia.mesh.visible=!0,Na.mesh.visible=!0,Oa.mesh.visible=!0,Fa.mesh.visible=!0}function Vc(){La.mesh.visible=!1,Pa.mesh.visible=!1,Da.mesh.visible=!1,Ua.mesh.visible=!1,Ia.mesh.visible=!1,Na.mesh.visible=!1,Oa.mesh.visible=!1,Fa.mesh.visible=!1}function Tn(i){kt.obj.visible=!0,Zt.obj.visible=!0,Qt.obj.visible=!0,en.obj.visible=!0,tn.obj.visible=!0,Gt.obj.visible=!0,Vt.obj.visible=!0,fn.obj.visible=!0,i!==void 0&&(i.obj.visible=!1)}function dn(i){Et.obj.visible=!1,Tt.obj.visible=!1,At.obj.visible=!1,wt.obj.visible=!1,Rt.obj.visible=!1,gt.obj.visible=!1,vt.obj.visible=!1,Ct.obj.visible=!1,i!==void 0&&(i.obj.visible=!0)}function Ag(i){kt.label.style.opacity=1,Zt.label.style.opacity=1,Qt.label.style.opacity=1,en.label.style.opacity=1,tn.label.style.opacity=1,Gt.label.style.opacity=1,Vt.label.style.opacity=1,fn.label.style.opacity=1,i!==void 0&&(i.label.style.opacity=0)}function wg(i){kt.label.style.opacity=0,Zt.label.style.opacity=0,Qt.label.style.opacity=0,en.label.style.opacity=0,tn.label.style.opacity=0,Gt.label.style.opacity=0,Vt.label.style.opacity=0,fn.label.style.opacity=0,i!==void 0&&(i.label.style.opacity=1)}function Rg(i){Et.label.style.opacity=1,Tt.label.style.opacity=1,At.label.style.opacity=1,wt.label.style.opacity=1,Rt.label.style.opacity=1,gt.label.style.opacity=1,vt.label.style.opacity=1,Ct.label.style.opacity=1,i!==void 0&&(i.label.style.opacity=0)}function Wc(i){i!==void 0&&(i.label.style.opacity=1),Et.label.style.opacity=0,Tt.label.style.opacity=0,At.label.style.opacity=0,wt.label.style.opacity=0,Rt.label.style.opacity=0,gt.label.style.opacity=0,vt.label.style.opacity=0,Ct.label.style.opacity=0,i!==void 0&&(i.label.style.opacity=1)}
